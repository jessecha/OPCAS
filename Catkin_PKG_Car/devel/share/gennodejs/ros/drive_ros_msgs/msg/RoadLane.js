...
class RoadLane {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('roadStateType')) {
        this.roadStateType = initObj.roadStateType
      }
      else {
        this.roadStateType = 0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [roadStateType]
    bufferOffset = _serializer.uint8(obj.roadStateType, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [roadStateType]
    data.roadStateType = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoadLane(null);
    ...
    if (msg.roadStateType !== undefined) {
      resolved.roadStateType = msg.roadStateType;
    }
    else {
      resolved.roadStateType = 0
    }

...
class mav_cc16_CONFIG_PARAM_SET_INT {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_CONFIG_PARAM_SET_INT(null);
  ...
  static datatype() {
    ...
    return 'drive_ros_msgs/mav_cc16_CONFIG_PARAM_SET_INT';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '13a44efe541a5bf1e48949df36ecdb1d';
  }

  static messageDefinition() {
    // Returns full string definition for message
    return `
    # Automatically Generated in 2017-06-12 22:33:47.453203
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_CONFIG_PARAM_SET_INT(null);
...
mav_cc16_CONFIG_PARAM_SET_INT.Constants = {
  ID: 200,
}

module.exports = mav_cc16_CONFIG_PARAM_SET_INT;

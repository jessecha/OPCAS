...
class mav_cc16_ODOMETER_DELTA_RAW {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_ODOMETER_DELTA_RAW(null);
  ...
  static messageDefinition() {
    ...
    return `
    # Automatically Generated in 2017-06-12 22:33:47.452947
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_ODOMETER_DELTA_RAW(null);
...
mav_cc16_ODOMETER_DELTA_RAW.Constants = {
  ID: 139,
}

module.exports = mav_cc16_ODOMETER_DELTA_RAW;

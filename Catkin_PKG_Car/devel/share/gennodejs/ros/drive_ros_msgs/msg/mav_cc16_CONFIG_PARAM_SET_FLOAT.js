...
class mav_cc16_CONFIG_PARAM_SET_FLOAT {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_CONFIG_PARAM_SET_FLOAT(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_CONFIG_PARAM_SET_FLOAT(null);
...
mav_cc16_CONFIG_PARAM_SET_FLOAT.Constants = {
  ID: 202,
}

module.exports = mav_cc16_CONFIG_PARAM_SET_FLOAT;

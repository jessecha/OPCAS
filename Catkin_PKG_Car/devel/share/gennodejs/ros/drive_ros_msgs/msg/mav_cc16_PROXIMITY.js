...
class mav_cc16_PROXIMITY {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_PROXIMITY(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_PROXIMITY(null);
...
mav_cc16_PROXIMITY.Constants = {
  ID: 144,
}

module.exports = mav_cc16_PROXIMITY;

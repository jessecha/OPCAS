...
class mav_cc16_ODOMETER_RAW {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_ODOMETER_RAW(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_ODOMETER_RAW(null);
...
mav_cc16_ODOMETER_RAW.Constants = {
  ID: 137,
}

module.exports = mav_cc16_ODOMETER_RAW;

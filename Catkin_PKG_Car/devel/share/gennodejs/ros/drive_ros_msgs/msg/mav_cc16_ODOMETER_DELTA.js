...
class mav_cc16_ODOMETER_DELTA {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new mav_cc16_ODOMETER_DELTA(null);
  ...
  static datatype() {
    ...
    return 'drive_ros_msgs/mav_cc16_ODOMETER_DELTA';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6ee1e844bf27efa55ebf26ba40c9385c';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new mav_cc16_ODOMETER_DELTA(null);
...
mav_cc16_ODOMETER_DELTA.Constants = {
  ID: 138,
}

module.exports = mav_cc16_ODOMETER_DELTA;

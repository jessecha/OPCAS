...
"""autogenerated by genpy from drive_ros_msgs/RoadLine.msg. Do not edit."""
import sys
...
class RoadLine(genpy.Message):
  _md5sum = "372f68ca7096e5f6db8beda284620015"
  _type = "drive_ros_msgs/RoadLine"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# line points
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.lineType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.lineType,) = _get_struct_B().unpack(str[start:end])
      return self

...
"""autogenerated by genpy from drive_ros_msgs/mav_cc16_CONFIG_PARAM_FLOAT.msg. Do not edit."""
import sys
...
class mav_cc16_CONFIG_PARAM_FLOAT(genpy.Message):
  _md5sum = "741fdd8de6581857c65264e7de5761ef"
  _type = "drive_ros_msgs/mav_cc16_CONFIG_PARAM_FLOAT"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Automatically Generated in 2017-06-12 22:33:47.453178
...
"""
  ...
  _slot_types = ['uint8','uint8','uint8','uint8','char[30]','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mav_cc16_CONFIG_PARAM_FLOAT, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_4f().pack(_x.value, _x.default_value, _x.min, _x.max))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.value, _x.default_value, _x.min, _x.max,) = _get_struct_4f().unpack(str[start:end])
      return self

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DPadEditDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 103, 25),
QT_MOC_LITERAL(8, 129, 22),
QT_MOC_LITERAL(9, 152, 5),
QT_MOC_LITERAL(10, 158, 21)
    },
...
void DPadEditDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DPadEditDialog *_t = static_cast<DPadEditDialog *>(_o);
        switch (_id) {
...
const QMetaObject DPadEditDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DPadEditDialog.data,
      qt_meta_data_DPadEditDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DPadEditDialog.stringdata))
        return static_cast<void*>(const_cast< DPadEditDialog*>(this));

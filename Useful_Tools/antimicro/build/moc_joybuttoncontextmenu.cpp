...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyButtonContextMenu_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 76, 11)
    ...
    "switchTurbo\0switchSetMode\0disableSetMode\0"
    "clearButton\0"
};
...
void JoyButtonContextMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyButtonContextMenu *_t = static_cast<JoyButtonContextMenu *>(_o);
        switch (_id) {
        case 0: _t->switchToggle(); break;
        case 1: _t->switchTurbo(); break;
        case 2: _t->switchSetMode(); break;
...
const QMetaObject JoyButtonContextMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_JoyButtonContextMenu.data,
      qt_meta_data_JoyButtonContextMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyButtonContextMenu.stringdata))
        return static_cast<void*>(const_cast< JoyButtonContextMenu*>(this));

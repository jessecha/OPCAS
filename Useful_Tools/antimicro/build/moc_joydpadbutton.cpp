...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyDPadButton_t, stringdata) + ofs \
...
void JoyDPadButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyDPadButton *_t = static_cast<JoyDPadButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (JoyDPadButton::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoyDPadButton::setAssignmentChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject JoyDPadButton::staticMetaObject = {
    { &JoyButton::staticMetaObject, qt_meta_stringdata_JoyDPadButton.data,
      qt_meta_data_JoyDPadButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyDPadButton.stringdata))
        return static_cast<void*>(const_cast< JoyDPadButton*>(this));

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyControlStickButtonPushButton_t, stringdata) + ofs \
...
void JoyControlStickButtonPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyControlStickButtonPushButton *_t = static_cast<JoyControlStickButtonPushButton *>(_o);
        switch (_id) {
...
const QMetaObject JoyControlStickButtonPushButton::staticMetaObject = {
    { &FlashButtonWidget::staticMetaObject, qt_meta_stringdata_JoyControlStickButtonPushButton.data,
      qt_meta_data_JoyControlStickButtonPushButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyControlStickButtonPushButton.stringdata))
        return static_cast<void*>(const_cast< JoyControlStickButtonPushButton*>(this));

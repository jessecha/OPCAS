...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyAxisButton_t, stringdata) + ofs \
...
void JoyAxisButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyAxisButton *_t = static_cast<JoyAxisButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (JoyAxisButton::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoyAxisButton::setAssignmentChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject JoyAxisButton::staticMetaObject = {
    { &JoyGradientButton::staticMetaObject, qt_meta_stringdata_JoyAxisButton.data,
      qt_meta_data_JoyAxisButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyAxisButton.stringdata))
        return static_cast<void*>(const_cast< JoyAxisButton*>(this));

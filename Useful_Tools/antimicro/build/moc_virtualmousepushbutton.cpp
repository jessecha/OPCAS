...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VirtualMousePushButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 65, 14)
    ...
    "\0JoyButtonSlot*\0tempslot\0createTempSlot\0"
};
...
void VirtualMousePushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VirtualMousePushButton *_t = static_cast<VirtualMousePushButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (VirtualMousePushButton::*_t)(JoyButtonSlot * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VirtualMousePushButton::mouseSlotCreated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject VirtualMousePushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_VirtualMousePushButton.data,
      qt_meta_data_VirtualMousePushButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VirtualMousePushButton.stringdata))
        return static_cast<void*>(const_cast< VirtualMousePushButton*>(this));

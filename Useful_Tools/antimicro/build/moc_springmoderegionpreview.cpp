...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SpringModeRegionPreview_t, stringdata) + ofs \
...
void SpringModeRegionPreview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SpringModeRegionPreview *_t = static_cast<SpringModeRegionPreview *>(_o);
        switch (_id) {
...
const QMetaObject SpringModeRegionPreview::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SpringModeRegionPreview.data,
      qt_meta_data_SpringModeRegionPreview,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpringModeRegionPreview.stringdata))
        return static_cast<void*>(const_cast< SpringModeRegionPreview*>(this));

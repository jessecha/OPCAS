...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StickPushButtonGroup_t, stringdata) + ofs \
...
void StickPushButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StickPushButtonGroup *_t = static_cast<StickPushButtonGroup *>(_o);
        switch (_id) {
        ...
        case 4: _t->openStickButtonDialog(); break;
        ...
        {
            typedef void (StickPushButtonGroup::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StickPushButtonGroup::buttonSlotChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject StickPushButtonGroup::staticMetaObject = {
    { &QGridLayout::staticMetaObject, qt_meta_stringdata_StickPushButtonGroup.data,
      qt_meta_data_StickPushButtonGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StickPushButtonGroup.stringdata))
        return static_cast<void*>(const_cast< StickPushButtonGroup*>(this));

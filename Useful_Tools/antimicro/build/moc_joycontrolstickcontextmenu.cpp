...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyControlStickContextMenu_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 56, 23)
    ...
    "\0setStickMode\0openMouseSettingsDialog\0"
};
...
void JoyControlStickContextMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyControlStickContextMenu *_t = static_cast<JoyControlStickContextMenu *>(_o);
        switch (_id) {
        case 0: _t->setStickPreset(); break;
        case 1: _t->setStickMode(); break;
...
const QMetaObject JoyControlStickContextMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_JoyControlStickContextMenu.data,
      qt_meta_data_JoyControlStickContextMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyControlStickContextMenu.stringdata))
        return static_cast<void*>(const_cast< JoyControlStickContextMenu*>(this));

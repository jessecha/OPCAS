...
QT_MOC_LITERAL(6, 46, 17)
    ...
    "Logger\0stringWritten\0\0text\0pendingMessage\0"
    "Log\0startPendingTimer\0"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->stringWritten((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->pendingMessage(); break;
        case 2: _t->Log(); break;
        case 3: _t->startPendingTimer(); break;
        default: ;
        }
        ...
        {
            typedef void (Logger::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Logger::stringWritten)) {
                *result = 0;
            }
        }
        {
            typedef void (Logger::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Logger::pendingMessage)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Logger::stringWritten(QString _t1)
{

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MouseButtonSettingsDialogHelper_t, stringdata) + ofs \
...
void MouseButtonSettingsDialogHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MouseButtonSettingsDialogHelper *_t = static_cast<MouseButtonSettingsDialogHelper *>(_o);
        switch (_id) {
...
const QMetaObject MouseButtonSettingsDialogHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseButtonSettingsDialogHelper.data,
      qt_meta_data_MouseButtonSettingsDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MouseButtonSettingsDialogHelper.stringdata))
        return static_cast<void*>(const_cast< MouseButtonSettingsDialogHelper*>(this));

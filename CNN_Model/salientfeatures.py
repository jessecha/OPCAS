...
def build_cnn(w=320, h=240, d=3):
    ...
    model.add(Convolution2D(filters=64, kernel_size=(3, 3),
        strides=(2,2),data_format='channels_last', input_shape=(h, w, d), activation='elu', name = 'conv4'))
    #model.add(ELU())
    #model.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding='valid', data_format=None))
    model.add(Convolution2D(filters=64, kernel_size=(3, 3),
        strides=(2,2),data_format='channels_last', input_shape=(h, w, d), activation='elu', name = 'conv5'))
    #model.add(ELU())
    #model.add(MaxPooling2D(pool_size=(2, 2), strides=(2,2), padding='valid', data_format=None))
    #model.add(Convolution2D(filters=64, kernel_size=(3, 3),
...
x = Convolution2D(64, (3,3), strides=(2,2), activation='elu', name='conv4', input_shape=(h, w, d))(x)
...
def compute_visualisation_mask(img):
    ...
    upscaled_activation = np.ones((11,16))#((6, 3))

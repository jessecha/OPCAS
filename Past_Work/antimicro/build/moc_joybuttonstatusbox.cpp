...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyButtonStatusBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 51, 10)
    ...
    "JoyButtonStatusBox\0flashed\0\0flashing\0"
    "flash\0unflash\0isflashing\0"
};
...
void JoyButtonStatusBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyButtonStatusBox *_t = static_cast<JoyButtonStatusBox *>(_o);
        switch (_id) {
        case 0: _t->flashed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->flash(); break;
        case 2: _t->unflash(); break;
        default: ;
        }
        ...
        {
            typedef void (JoyButtonStatusBox::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoyButtonStatusBox::flashed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject JoyButtonStatusBox::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_JoyButtonStatusBox.data,
      qt_meta_data_JoyButtonStatusBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyButtonStatusBox.stringdata))
        return static_cast<void*>(const_cast< JoyButtonStatusBox*>(this));
...
// SIGNAL 0
void JoyButtonStatusBox::flashed(bool _t1)
{

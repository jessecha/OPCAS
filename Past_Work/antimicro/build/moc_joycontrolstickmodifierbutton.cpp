...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyControlStickModifierButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 29)
    ...
    "JoyControlStickModifierButton\0"
};
...
const QMetaObject JoyControlStickModifierButton::staticMetaObject = {
    { &JoyGradientButton::staticMetaObject, qt_meta_stringdata_JoyControlStickModifierButton.data,
      qt_meta_data_JoyControlStickModifierButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyControlStickModifierButton.stringdata))
        return static_cast<void*>(const_cast< JoyControlStickModifierButton*>(this));

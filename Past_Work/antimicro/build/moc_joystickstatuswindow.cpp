...
#include "../src/joystickstatuswindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoystickStatusWindow_t, stringdata) + ofs \
...
void JoystickStatusWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoystickStatusWindow *_t = static_cast<JoystickStatusWindow *>(_o);
        switch (_id) {
...
const QMetaObject JoystickStatusWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_JoystickStatusWindow.data,
      qt_meta_data_JoystickStatusWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoystickStatusWindow.stringdata))
        return static_cast<void*>(const_cast< JoystickStatusWindow*>(this));

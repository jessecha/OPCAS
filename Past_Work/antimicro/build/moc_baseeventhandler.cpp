...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BaseEventHandler_t, stringdata) + ofs \
...
const QMetaObject BaseEventHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BaseEventHandler.data,
      qt_meta_data_BaseEventHandler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BaseEventHandler.stringdata))
        return static_cast<void*>(const_cast< BaseEventHandler*>(this));

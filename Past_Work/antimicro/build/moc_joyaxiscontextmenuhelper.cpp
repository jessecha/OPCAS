...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyAxisContextMenuHelper_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 110, 24)
    ...
    "mode\0setPAssignedSlot\0clearAndResetAxisButtons\0"
};
...
void JoyAxisContextMenuHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyAxisContextMenuHelper *_t = static_cast<JoyAxisContextMenuHelper *>(_o);
        switch (_id) {
        case 0: _t->setNAssignedSlot((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< JoyButtonSlot::JoySlotInputAction(*)>(_a[3]))); break;
        case 1: _t->setNAssignedSlot((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        case 2: _t->setPAssignedSlot((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< JoyButtonSlot::JoySlotInputAction(*)>(_a[3]))); break;
        case 3: _t->setPAssignedSlot((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
...
const QMetaObject JoyAxisContextMenuHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_JoyAxisContextMenuHelper.data,
      qt_meta_data_JoyAxisContextMenuHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyAxisContextMenuHelper.stringdata))
        return static_cast<void*>(const_cast< JoyAxisContextMenuHelper*>(this));

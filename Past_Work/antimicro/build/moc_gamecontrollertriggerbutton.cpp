...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GameControllerTriggerButton_t, stringdata) + ofs \
...
const QMetaObject GameControllerTriggerButton::staticMetaObject = {
    { &JoyAxisButton::staticMetaObject, qt_meta_stringdata_GameControllerTriggerButton.data,
      qt_meta_data_GameControllerTriggerButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameControllerTriggerButton.stringdata))
        return static_cast<void*>(const_cast< GameControllerTriggerButton*>(this));

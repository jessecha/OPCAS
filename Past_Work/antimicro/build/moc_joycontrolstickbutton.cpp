...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyControlStickButton_t, stringdata) + ofs \
...
void JoyControlStickButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyControlStickButton *_t = static_cast<JoyControlStickButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (JoyControlStickButton::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoyControlStickButton::setAssignmentChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject JoyControlStickButton::staticMetaObject = {
    { &JoyGradientButton::staticMetaObject, qt_meta_stringdata_JoyControlStickButton.data,
      qt_meta_data_JoyControlStickButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyControlStickButton.stringdata))
        return static_cast<void*>(const_cast< JoyControlStickButton*>(this));

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GameControllerMappingDialogHelper_t, stringdata) + ofs \
...
void GameControllerMappingDialogHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GameControllerMappingDialogHelper *_t = static_cast<GameControllerMappingDialogHelper *>(_o);
        switch (_id) {
...
const QMetaObject GameControllerMappingDialogHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameControllerMappingDialogHelper.data,
      qt_meta_data_GameControllerMappingDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameControllerMappingDialogHelper.stringdata))
        return static_cast<void*>(const_cast< GameControllerMappingDialogHelper*>(this));

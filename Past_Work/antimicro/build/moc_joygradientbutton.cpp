...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_JoyGradientButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 49, 20)
    ...
    "wheelEventVertical\0wheelEventHorizontal\0"
};
...
void JoyGradientButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        JoyGradientButton *_t = static_cast<JoyGradientButton *>(_o);
        switch (_id) {
...
const QMetaObject JoyGradientButton::staticMetaObject = {
    { &JoyButton::staticMetaObject, qt_meta_stringdata_JoyGradientButton.data,
      qt_meta_data_JoyGradientButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_JoyGradientButton.stringdata))
        return static_cast<void*>(const_cast< JoyGradientButton*>(this));

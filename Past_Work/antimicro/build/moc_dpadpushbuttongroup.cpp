...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DPadPushButtonGroup_t, stringdata) + ofs \
...
void DPadPushButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DPadPushButtonGroup *_t = static_cast<DPadPushButtonGroup *>(_o);
        switch (_id) {
        ...
        case 4: _t->openDPadButtonDialog(); break;
        ...
        {
            typedef void (DPadPushButtonGroup::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DPadPushButtonGroup::buttonSlotChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DPadPushButtonGroup::staticMetaObject = {
    { &QGridLayout::staticMetaObject, qt_meta_stringdata_DPadPushButtonGroup.data,
      qt_meta_data_DPadPushButtonGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DPadPushButtonGroup.stringdata))
        return static_cast<void*>(const_cast< DPadPushButtonGroup*>(this));

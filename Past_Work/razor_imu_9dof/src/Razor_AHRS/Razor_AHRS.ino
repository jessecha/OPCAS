...
float ACCEL_X_MIN = -258;
float ACCEL_X_MAX = 258;
float ACCEL_Y_MIN = -257;
float ACCEL_Y_MAX = 253;
float ACCEL_Z_MIN = -269;
float ACCEL_Z_MAX = 238;
...
float magn_ellipsoid_center[3] = {18.8804, -63.4868, -72.1681};
float magn_ellipsoid_transform[3][3] = {{0.900673, 0.0356804, -0.00611356}, {0.0356804, 0.899987, 0.0444685}, {-0.00611356, 0.0444685, 0.979130}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -5.41;
float GYRO_AVERAGE_OFFSET_Y = -15.09;
float GYRO_AVERAGE_OFFSET_Z = 14.12;

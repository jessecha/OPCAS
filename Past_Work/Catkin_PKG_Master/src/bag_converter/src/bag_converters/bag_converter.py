...
class ImageCreator():
    ...
    # Must have __init__(self) function for a class, similar to a C++ class constructor.
		...
		if len(sys.argv) < 1:
                    pathtwo = "/home/jesse/Desktop/imagefiles"
                    path = "/media/jesse/fea384dc-a790-4a8a-8baf-e65d9416e2ba" 
		...
		with rosbag.Bag(filename, 'r') as bag:
		    for topic, msg, time in bag.read_messages():
		        if (cmp(topic, "/camera1/image_raw") == 0):
